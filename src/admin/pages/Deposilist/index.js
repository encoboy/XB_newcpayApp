...
const { Group: RadioGroup } = Radio;
 ...
 class Deposilist extends Component{
  ...
  render(){
    const {dataSource,type,pagination,footer,is_getpagealltotal,
      getalltotal,getpagetotal,show,detaildata,depositID,alltotal,pagetotal,is_pagealltotal,count,id} = this.state;
