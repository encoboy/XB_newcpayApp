...
import { Table,Pagination,Button, Balloon } from '@icedesign/base';
 ...
 class CustomTable extends Component {
  ...
  render() {
    const {dataSource,pagination,type,is_getpagealltotal,
      getpagetotal,pagetotal,is_pagealltotal,getalltotal,alltotal,count  } = this.state;
      ...
      <div>
        ...
        <Table dataSource={dataSource} hasBorder={false} >
          ...
          <Table.Column
            ...
            // cell={(text,index,record)=><div>{record.bank.toUpperCase()} {text}</div>}
          />
          <Table.Column
            key='debit'
            dataIndex='debit'
          ...
          <Table.Column
            ...
            cell={(text,index,record)=>(
              hasAction(btn,'BankJournal_changejournal')&&
              <EditDialog
                record={record}
