...
export default class Form extends Component{
  ...
  validateAllFormField = () => {
    this.refs.form.validateAll((errors, values) => {
     ...
     // if(values.start){
     //    values.start=moment(values.date[0]).format('YYYYMMDDHHmmss');
     //    values.stop=moment(values.date[1]).format('YYYYMMDDHHmmss');
     // }
     //  delete values.date;
      const params = {
        ...
        <div style={styles.formContent}>
          <Row wrap >
            <Col xxs="24" s="4" l="4" style={styles.formItem} >
              <IceFormBinder name="accountnumber"  >
            ...
            <Col xxs="24" s="4" l="4" style={styles.formItem} >
              <IceFormBinder name="start" >
                <DatePicker style={{maxWidth:'300px'}} disabledDate={this.disabledDate}  showTime={{
