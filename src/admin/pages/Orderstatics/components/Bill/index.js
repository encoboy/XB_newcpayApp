 ...
 class BankCard extends Component{
  ...
  searchwithdraw = (values)=>{
    ...
    _fetch({
      ...
      success:(data)=>{
        console.log('searchorderreport',data);
    ...
    return(
      <div>
        ...
        <Table dataSource={dataSource} hasBorder={false} >
          ...
          />
          <Table.Column
            key='order_deposit_pendingverified'
            dataIndex='order_deposit_pendingverified'
            width={100}
            title={_intl.get('order.deposit_pendimgverified')}
          />
          <Table.Column
          key='order_deposit_pendingverified_times'
          dataIndex='order_deposit_pendingverified_times'
          width={100}
          title={_intl.get('order.deposit_pendimgverified_times')}
        />
        <Table.Column
