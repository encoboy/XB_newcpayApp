          ...
          <ul style={styles.detailTable}>
            ...
            <li style={styles.detailItem}>
              ...
              <div style={styles.detailBody}>
                ...
                {
                  ['success','error','pendingverified'].includes(data.status)&&
                ...
                {/*{*/}
                  {/*data.status==='verified'&&hasAction(btn,'Order_setverified')&&*/}
                ...
                {/*
                  data.status==='error'&&
                    <span>
                       {hasAction(btn,'Order_setfail')&&<Button style={{marginLeft:'5px'}}  type='normal' shape='warning' onClick={()=>this.setStatus('normal','fail',data.id)}>{_intl.get('order.setFail')}</Button>}
                       <Button style={{marginLeft:'5px'}} type='primary' onClick={()=>this.setStatus('normal','verified',data.id)}>{_intl.get('order.setVerified')}</Button>
                    </span>
                */}
              </div>
            ...
            <li style={styles.detailItem}>
              ...
              <div style={styles.amount}>
                ...
                {data.status==='pendingverified'&&<Button style={{marginLeft:'5px'}}  type='primary' onClick={()=>this.touchverify(data.id)}>{_intl.get('order.touchverify')}</Button>}
              </div>
            </li>
          </ul>
        </Card>
