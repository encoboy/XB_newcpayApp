...
class CustomTable extends Component {
  ...
  updatePwd = (obj) => {
    return (psaaword)=>{
      obj.value = sha1(obj.username.toLowerCase()+psaaword);
      this.updateSub(obj)
    };
  };
        ...
        <Table dataSource={dataSource} hasBorder={false} >
          ...
          <Table.Column
            ...
            cell={(text,index,record)=>{
              return(
                <span>
                <RevisePwd onOk={this.updatePwd({type:'psw',id:record.id,username:record.username})} />
...
export default connect(mapStatToProp,mapDispatchToProps)(CustomTable);
