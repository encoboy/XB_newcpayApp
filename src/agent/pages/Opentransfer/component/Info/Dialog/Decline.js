...
//   }
  ...
  render() {
    ...
    return (
      ...
      <Dialog
        ...
        autoFocus={false}
        footerAlign="center"
        title={_intl.get('waitetransfer.no')}
        {...this.props}
        onOk={this.onOk}
  ...
  <Form direction="ver" field={this.field } labelAlign='top'>
    ...
    {hasAction(btn,'Amend_transferno')&&<Button type="secondary" onClick={()=>this.showDialog(data)} >
        {_intl.get('waitetransfer.no')}
    </Button>}
  </div>
    );
  }
...
export default connect(mapStatToProp)(Decline);
