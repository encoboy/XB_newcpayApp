...
class SimpleFormDialog extends Component {
  ...
  onOk = () => {
    this.field.validate((error,values) => {
      ...
      _fetch({
        ...
        success:(data)=>{
          console.log('setonly',data);
          this.hideDialog();
          this.props.monopolizeOk();
        }
      });
  ...
  whetherMonopolze = () => {
    ...
    Dialog.confirm({
      content: _intl.get('order.markedWords'),
      onOk:() => {
  ...
  render() {
    ...
    return (
      <span>
        ...
        <Button  type="normal" shape="text" onClick={this.whetherMonopolze} >
          {_intl.get('order.monopolize')}
        </Button>
      </span>
    );
  }
