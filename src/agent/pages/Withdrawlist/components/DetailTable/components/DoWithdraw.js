  ...
  render() {
    ...
    return (
      <span>
        ...
        {is_transfer!==1&& <Button style={{margin:'0 10px'}} type="normal" shape="warning" onClick={()=>this.showDialog('reject')}>{_intl.get('withdraw.reject')}</Button>}
      </span>
    );
  }
}
