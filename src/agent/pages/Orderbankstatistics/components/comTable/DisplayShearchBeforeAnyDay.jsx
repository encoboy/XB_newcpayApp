...
// 是搜索，但不是搜索今天的日期，而是搜索今天之前的日期，显示的只有一条数据。
// 这个页面是有title的。
// DisplayShearchBeforeAnyDay
export default class Index extends Component {
  ...
  render() {
    ...
    return (
            ...
            >
              <Row>
                  <Col span='3' className="demo-col1">{_intl.get("bankstatistics.querydate")}</Col>
                  <Col span='21' className="demo-col3">
                      {item.querydate}
              ...
              <Row>
                  <Col span='3' className="demo-col1">{_intl.get("bankstatistics.summary")}</Col>
                  <Col span='21' className="demo-col3">
              ...
              <Row>
                  <Col span='3' className="demo-col1">{_intl.get("bankstatistics.rate")}</Col>
                  <Col span='21' className="demo-col3">
              ...
              <Row>
                  <Col span='3' className="demo-col1" style={styles.fontCenter}>
                  {_intl.get("bankstatistics.bankuser")}
                  </Col>
                  <Col span='21' className="demo-col3">
                  <Bank data={item.data}/>
                  </Col>
              ...
              <Row>
                  <Col span='3' className="demo-col1">{_intl.get("bankstatistics.orderall")}</Col>
                  <Col span='21' className="demo-col3">{item.success_amount}</Col>
              </Row>
              <Row>
                  <Col span='3' className="demo-col4">{_intl.get("bankstatistics.updated")}</Col>
                  <Col span='21' className="demo-col5">{item.updated&&item.updated}</Col>
              </Row>
            </div>
    );
  }
