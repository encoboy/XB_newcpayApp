...
const Toast = Feedback.toast;
 class transferdailylist extends Component{
  state = {
    type:'transfer',
    datetype:'daily',
    dataSource : [],
  ...
  render(){
    ...
    return(
      <div className="transferdailylist">
        <CustomBreadcrumb/>
        <IceContainer>
          {/*<RadioGroup
            shape="button"
         ...
         />
          ...
          />
          <Table.Column
            key='wallet_transfer_all_times'
            dataIndex='wallet_transfer_all_times'
            width={70}
            title={_intl.get('bill.wallet_transfer_all_times')}
          />
          <Table.Column
          ...
          />
          <Table.Column
          key='wallet_transfer_manual_total'
          dataIndex='wallet_transfer_manual_total'
          width={100}
          title={_intl.get('bill.wallet_transfer_manual_total')}
          />
          <Table.Column
          key='wallet_transfer_manual_all_times'
          dataIndex='wallet_transfer_manual_all_times'
          width={100}
          title={_intl.get('bill.wallet_transfer_manual_all_times')}
          />
          <Table.Column
            key='wallet_transfer_manual_fee'
            dataIndex='wallet_transfer_manual_fee'
            width={100}
          ...
          />
          <Table.Column
          key='wallet_transfer_manual_extra'
          dataIndex='wallet_transfer_manual_extra'
          width={100}
