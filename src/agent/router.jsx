...
import {fetchPosts,logo_fetch} from './redux/action';
...
class App extends React.Component{
  constructor(props) {
    ...
    window.logo_fetch = this.props.logo_fetch;
    window._intl = intl;
  }
  componentDidMount() {
  ...
  loadLocales(language) {
    localStorage.setItem('agent-lang',language);
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    logo_fetch:(obj,loading)=>dispatch(logo_fetch(obj,loading))
  }
};
