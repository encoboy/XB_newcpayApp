...
export function getUserInfo() {
  return{
    username:localStorage.getItem('agent-username'),
    password:localStorage.getItem('agent-password'),
    lang:localStorage.getItem('agent-lang')
  }
}
...
export function errorHanldling(error) {
  // const redDot = ['transferlist','getwithdrawlist','warninglist'];
